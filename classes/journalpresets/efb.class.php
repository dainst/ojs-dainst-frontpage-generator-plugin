...
class efb extends journalpreset {
	function setMetadata($data) {
		...
		$this->lang->terms->en  = "<b style=\"font-family:calibrib\">Terms of use:</b> The Research E-Papers {$this->metadata['year']} of the Deutsches Archäologisches Institut is published under the Creative-Commons-Licence BY – NC – ND 4.0 International. <br> 
