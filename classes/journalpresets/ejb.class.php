...
class ejb extends journalpreset {
	function setMetadata($data) {
		$this->lang->terms->de 	= "<b style=\"font-family:calibrib\">Nutzungsbedingungen:</b> Die e-Jahresberichte {$this->metadata['year']} des Deutschen Archäologischen Instituts stehen unter der Creative-Commons-Lizenz Namensnennung – Nicht kommerziell – Keine Bearbeitungen 4.0 International.
		...
		$this->lang->terms->en  = "<b style=\"font-family:calibrib\">Terms of use:</b> The Annual E-Report {$this->metadata['year']} of the Deutsches Archäologisches Institut is published under the Creative-Commons-Licence BY – NC – ND 4.0 International. <br> 
